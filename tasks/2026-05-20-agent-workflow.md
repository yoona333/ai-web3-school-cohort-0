# Task Note: Configure Coding / Learning Agent Workflow
...
- Configure a coding / learning agent workflow that supports learning.
- Make clear that the agent helps with planning, explaining, exercises, repo maintenance, questions, and drafts.
...
The workflow is documented in `agent-workflow.md`.
...
- The workflow is public and reviewable.
- The agent is positioned as a learning assistant, not a substitute learner.
